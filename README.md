...
- [ ] OPTIMIZE OPTIMIZE OPTIMIZE. I've now learned what and what not to use Redux for... Removed UI state handling from addressSlice to stop unecessary re-renderings
