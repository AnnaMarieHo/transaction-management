...
const ReceiptTemplate = (props) => {
    ...
    return (
        ...
        >
            ...
            <div className="absolute top-2 right-2 text-[9px] sm:text-[10px] font-mono text-slate-300 dark:text-slate-600">
                REF: {props.reciept_id}
            </div>

            <div className="text-center mb-4 sm:mb-6">
                <h4 className="font-black text-lg sm:text-xl tracking-tighter text-slate-900 dark:text-slate-100 uppercase">
                    Receipt
                </h4>
            ...
            <div className="border-t border-dashed border-slate-200 dark:border-slate-600 pt-3 sm:pt-4 space-y-1.5 sm:space-y-2">
                ...
                <div className="flex justify-between text-xs sm:text-sm">
                    ...
                    <span className="font-mono dark:text-slate-300">
                        ${props.highest_prices}
                    </span>
                </div>

                <div className="border-t-2 border-slate-900 dark:border-slate-600 pt-2 sm:pt-3 mt-1.5 sm:mt-2 flex justify-between items-baseline">
                    <span className="font-black text-slate-900 dark:text-slate-100 uppercase text-xs sm:text-sm">
                        Total Amount
                    </span>
            ...
            <div className="mt-4 sm:mt-6 flex justify-center">
                <div className="h-1 w-full bg-[radial-gradient(circle,_#e2e8f0_1px,_transparent_1px)] dark:bg-[radial-gradient(circle,_#475569_1px,_transparent_1px)] bg-[length:8px_8px]" />
            </div>
        </div>
    );
};
